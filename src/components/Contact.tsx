      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-16 pb-8 border-b border-white/10">
            <a href="https://github.com/ArcaIcr" className="p-3 border border-white/10 bg-[var(--color-cyber-card)] hover:border-[var(--color-cyber-neon)] hover:text-[var(--color-cyber-neon)] transition-all">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/me/" className="p-3 border border-white/10 bg-[var(--color-cyber-card)] hover:border-[var(--color-cyber-neon)] hover:text-[var(--color-cyber-neon)] transition-all">
              <Linkedin size={24} />
            </a>
            <a href="https://x.com/Koshi41219118" className="p-3 border border-white/10 bg-[var(--color-cyber-card)] hover:border-[var(--color-cyber-neon)] hover:text-[var(--color-cyber-neon)] transition-all">
              <Twitter size={24} />
            </a>
            <a href="https://www.facebook.com/ProCast2" className="p-3 border border-white/10 bg-[var(--color-cyber-card)] hover:border-[var(--color-cyber-neon)] hover:text-[var(--color-cyber-neon)] transition-all">
              <Facebook size={24} />
            </a>
            <a href="https://www.instagram.com/mkoht_4/?__pwa=1" className="p-3 border border-white/10 bg-[var(--color-cyber-card)] hover:border-[var(--color-cyber-neon)] hover:text-[var(--color-cyber-neon)] transition-all">
              <Instagram size={24} />
            </a>
          </div>
